...
class EmployersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post employers_url, params: { employer: { dob: @employer.dob, email: @employer.email, gender: @employer.gender, location: @employer.location, name: @employer.name, phone: @employer.phone, status: @employer.status } }
    end
  ...
  test "should update employer" do
    patch employer_url(@employer), params: { employer: { dob: @employer.dob, email: @employer.email, gender: @employer.gender, location: @employer.location, name: @employer.name, phone: @employer.phone, status: @employer.status } }
